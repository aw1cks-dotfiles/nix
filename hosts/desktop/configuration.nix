...
in
{
  configurations.nixos.desktop = {
    module = {
      ...
      # NVMe blk-mq IRQs are kernel-managed on this box; irqbalance cannot
      # rewrite them and otherwise logs noisy permission-denied messages.
      aw1cks.desktop.highPerf.irqbalance.extraArgs = [ "--banmod=nvme" ];
