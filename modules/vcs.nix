        ...
        git = {
          ...
          settings = {
            ...
            alias = {
              ...
              f = "fetch";
              fe = "fetch";
              fixup = "!f() { git commit --fixup=\${1:-$(git log --oneline | fzf | awk '{print \$1}')}; }; f";
              fixup-and-squash = "!f() { SHA=\${1:-$(git log --oneline | fzf | awk '{print \$1}')}; git commit --fixup=\$SHA && GIT_SEQUENCE_EDITOR=true git rebase -i --autosquash \$SHA^; }; f";
              i = "init";
              ...
              s = "status";
              sh = "show";
              squash = "!f() { GIT_SEQUENCE_EDITOR=true git rebase -i --autosquash \${1:-$(git log --oneline | fzf | awk '{print \$1}')}^; }; f";
              st = "status";
              sta = "stash";
              std = "stash drop";
              stp = "stash pop";
            ...
            "merge \"mergiraf\"".driver =
              "${pkgs.mergiraf}/bin/mergiraf merge --git %O %A %B -s %S -x %X -y %Y -p %P -l %L";
